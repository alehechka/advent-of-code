...
var data = []day2Datum{
	{
		...
		game: twentythree.Day2Game{ID: 1, Rounds: []twentythree.Day2Round{
			{Greens: 4, Blues: 2},
	...
	},
	{
		...
		game: twentythree.Day2Game{ID: 18, Rounds: []twentythree.Day2Round{
	...
	},
	{
		...
		game: twentythree.Day2Game{ID: 41, Rounds: []twentythree.Day2Round{
...
func test_ParseDay2Line(t *testing.T, expected day2Datum) {
	actual := twentythree.ParseDay2Line(expected.line)
